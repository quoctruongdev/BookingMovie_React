...
function AuthPage(props) {
  ...
  return (
    <div className="   flex    justify-center h-full	  w-full bg-gray-400   ">
      <div className="w-full max-w-md p-8   position: absolute  top-20  	  space-y-3 rounded-xl bg-gray-900 text-gray-200">
        ...
        <div className="flex items-center pt-4 space-x-1">
          <div className="flex-1 h-px sm:w-16 bg-gray-700" />
          <p className="px-3 text-sm text-gray-400">
            Please login with admin accounts
          </p>
          <div className="flex-1 h-px sm:w-16 bg-gray-700" />
        </div>
